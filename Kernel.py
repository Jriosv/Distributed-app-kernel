...
class Kernel:
    ...
    def start_app_module(self):
        global module1
        module1 = subprocess.Popen('python Apps.py')
    ...
    def start_files_module(self):
        global module3
        module3 = subprocess.Popen('python Files.py')
      
    def initialize_modules(self):
        self.start_files_module()
        time.sleep(3)
        self.start_app_module()
        time.sleep(3)

    
    def terminate_modules(self):
        app_location = self.registered_sockets['apps']
        files_location = self.registered_sockets['files']
        
        clients = [app_location,files_location]
        
        for client in clients:
            self.send_msg(cmd='stop',
                          src='kernel',
                          dst='all',
                          msg='finish the execution',
